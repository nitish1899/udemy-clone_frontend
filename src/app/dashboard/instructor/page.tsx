    ...
    async function fetchDashboardData() {
      try {
        const response = await axios.get(
          `${process.env.NEXT_PUBLIC_BACKEND_URL}/courses/instructor/dashboard`
        );
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={() =>
                    router.push(
                      `/dashboard/instructor/${course.id}/add-section`
                    )
                  }
                  ...
                  <li key={section.id} className="p-2 bg-gray-100 rounded-lg">
                    <div className="flex justify-between items-center">
                      ...
                      <button
                        onClick={() =>
                          router.push(
                            `/dashboard/instructor/${course.id}/sections/${section.id}/add-lecture`
                          )
                        }
